...
setkey("i", "kj", "<Esc>", { noremap = true })
setkey("n", "zz", "<cmd>w<cr><esc>", { noremap = true, silent = true, desc = "Save file" })
...
setkey("n", "<leader>,", "<cmd>BufferMovePrevious<CR>", { noremap = true, silent = true, desc = "[Barbar] Move tab to left" })
setkey("n", "<leader>.", "<cmd>BufferMoveNext<CR>", { noremap = true, silent = true, desc = "[Barbar] Move tab to right" })
...
-- Window
setkey("n", "<leader>td", "<cmd>tabclose<cr>", { noremap = true, silent = true, desc = "Close tab"})
...
-- LSP
setkey('n', 'gD', vim.lsp.buf.declaration, { noremap = true, silent = true, desc = "Goto Declaration"})
setkey('n', 'gd', vim.lsp.buf.definition, { noremap = true, silent = true, desc = "Goto Definition"})
setkey('n', 'K', vim.lsp.buf.hover, { noremap = true, silent = true, desc = "Hover"})
setkey('n', 'gi', vim.lsp.buf.implementation, { noremap = true, silent = true, desc = "Goto implementation"})
setkey('n', '<C-k>', vim.lsp.buf.signature_help, { noremap = true, silent = true, desc = "Signature Help"})
setkey('n', '<leader>D', vim.lsp.buf.type_definition, { noremap = true, silent= true, desc = "Goto T[y]pe Definition"})
setkey('n', '<leader>rn', vim.lsp.buf.rename, { noremap = true, silent = true, desc = "Rename"})
setkey({ 'n', 'v' }, '<space>ca', vim.lsp.buf.code_action, { noremap = true, silent = true, desc = "Code action"})
setkey('n', 'gr', function() require("telescope.builtin").lsp_references() end, { noremap = true, silent =true, desc = ""})
setkey('n', '<leader>sd', function() require("telescope.builtin").diagnostics() end, { noremap = true, silent = true, desc = ""})
